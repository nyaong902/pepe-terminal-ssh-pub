...
contextBridge.exposeInMainWorld('api', {
  ...
  sipCtrTransfer: (args: { endpointId: string; digits: string; number: string }) => ipcRenderer.invoke('sip:ctr-transfer', args),
  ...
  sipSendInfo: (args: { endpointId: string; header: string; value: string }) => ipcRenderer.invoke('sip:send-info', args),
  ...
  sipMediaPlay: (args: { endpointId: string; file: string }) => ipcRenderer.invoke('sip:media-play', args),
  sipMediaStop: (args: { endpointId: string }) => ipcRenderer.invoke('sip:media-stop', args),
  ...
  sipSetAccountAudioDevices: (args: { endpointId: string; input?: string; output?: string }) => ipcRenderer.invoke('sip:set-account-audio-devices', args),
  sipSetAccountVolume: (args: { endpointId: string; mic: number; speaker: number }) => ipcRenderer.invoke('sip:set-account-volume', args),
