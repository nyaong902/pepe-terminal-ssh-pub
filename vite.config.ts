      ...
      main: {
        ...
        vite: {
          build: {
            sourcemap: 'hidden',
            rollupOptions: {
              external: ['ssh2', 'cpu-features', 'iconv-lite', 'node-pty', 'webdav-server', 'electron-updater', '@xenova/transformers', 'onnxruntime-node', 'sharp', 'koffi', 'ws', 'bufferutil', 'utf-8-validate'],
            },
          },
        },
      },
